...
*/
	echo '<h1>Challenge 01 - c - Age Calculator</h1>';
...
//	$age_whole_days = $age_in_secs / 86400;
	$age_whole_years = floor($age_in_secs / (86400 * 365));
	$age_whole_days = floor(($age_in_secs % (86400 * 365)) / 86400);
	...
	echo 'you are ' . $age_whole_years . ' years, ' . $age_whole_days . ' days, ' . $age_whole_hours . ' hours, ' . $age_whole_minutes . ' minutes, and ' . $age_whole_seconds . ' seconds'; 
